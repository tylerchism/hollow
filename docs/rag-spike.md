...
- SQLite + WAL mode, per-agent at `/home/tchism/data/<agent>/memory.db`
...
**Per-person DB path convention:** `/home/tchism/data/corpus/<person_slug>/memory.db`
...
|---|---|---|
| `expert` (default) | `/home/tchism/data/corpus/<person_slug>/memory.db` | External thinker corpora |
| `archivist` | `/home/tchism/data/archivist/memory.db` | Hollow's own outputs, task logs, retro findings |
